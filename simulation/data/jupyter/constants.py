...
TYPE_EFFECTIVENESS = {
    ...
    'fighting': {
        'normal': 2, 'fire': 1, 'water': 1, 'grass': 1, 'electric': 1, 'ice': 2, 'fighting': 1, 'poison': 0.5, 'ground': 1,
    ...
    'dark': {
        ...
        'flying': 1, 'psychic': 2, 'bug': 1, 'rock': 1, 'ghost': 2, 'dragon': 2, 'dark': 0.5, 'steel': 1, 'fairy': 0.5
    },
    'steel': {
    ...
    'fairy': {
        'normal': 1, 'fire': 0.5, 'water': 1, 'grass': 1, 'electric': 1, 'ice': 1, 'fighting': 2, 'poison': 0.5, 'ground': 1,
